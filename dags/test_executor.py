...
dag = DAG(dag_id='test_executor2',default_args=args,schedule_interval=None)
...
one_task = PythonOperator(
    ...
    executor_config={"KubernetesExecutor": {"image": "kalbyimanie/airflow:v1"}}
)

# Use the zip binary, which is only found in this special docker image
two_task = PythonOperator(
    task_id="two_task", python_callable=print_stuff, dag=dag,
    executor_config={"KubernetesExecutor": {"image": "kalbyimanie/airflow:v1"}}
)
